...
class RegistryException extends \Exception
{
    ...
    const DUPLICATE_REGISTRATION_ATTEMPT_TEXT = "Given identifier (@id) already applies to an item of the registry. Please choose a different one.";

    const MODIFICATION_ATTEMPT_FAILED_CODE = 2;
    const MODIFICATION_ATTEMPT_FAILED_TEXT = "Given identifier (@id) does not applies to an item of the registry.";

    const UNKNOWN_IDENTIFIER_CODE = 3;
    const UNKNOWN_IDENTIFIER_TEXT = "Given identifier (@id) does not match a registered one.";
